...
return array (
  ...
  array (
    ...
    array (
      'message' => 
      array (
        'sent_by_html' => 'Отправлено %{user} %{x_ago}',
      ),
    ),
    'forum' => 
    array (
    ...
    array (
      ...
      array (
        ...
        'api' => 'API',
        'artists' => 'Художники',
        'bookmarklet' => 'Закладки',
        'bugs' => 'Ошибки',
        'cheat_sheet' => 'Шпаргалка',
        'comments' => 'Комментарии',
        'dtext' => 'DText',
        'firefox_ext' => 'Расширение для Firefox',
        'image_sampling' => 'Image Sampling',
        'irc' => 'IRC',
        'notes' => 'Заметки',
        'pools' => 'Коллекции',
        'posts' => 'Посты',
        'post_relationships' => 'Взаимосвязи Постов',
        'ratings' => 'Оценки',
        'source' => 'Исходный Код',
        'tag_scripts' => 'Сценарии Меток',
        'tags' => 'Метки',
        'tag_aliases' => 'Синонимы',
        'tag_implications' => 'Дополнительные Значения',
        'mass_tag_edit' => 'Массовая Правка Меток',
    ...
    array (
      ...
      'moderate' => 
      array (
        'uploaded_by_when_html' => 'Создано %{u} %{t_ago} (%{mod})',
        'mod' => 'mod',
      ),
    ),
    'activerecord' => 
    array (
      ...
      array (
        ...
        array (
          'wiki_page' => 
          array (
            'no_change' => 'Нет изменений в содержании/заголовке страницы',
          ),
        ),
      ),
    ),
    'artist_create' => 'Используйте запятую в качестве разделителя псевдонимов и членов группы',
    'artist_name' => 'Имя',
    'artist_alias_for' => 'Псевдоним для',
    'artist_aliases' => 'Псевдонимы',
    'artist_members' => 'Участники',
    'artist_urls' => 'URL\'ы',
    'artist_notes' => 'Примечание',
    'artist_save' => 'Сохранить',
    'artist_cancel' => 'Отмена',
    'artist_delete' => 'Удалить Художника',
    'artist_delete_text' => 'Вы действительно хотите удалить',
    'artist_delete_yes' => 'Да',
    'artist_delete_no' => 'Нет',
    'artist_delete_text_question_mark' => '?',
    'artist_footer_list' => 'Список',
    'artist_footer_add' => 'Добавить',
    'artist_footer_help' => 'Справка',
    'artist_index_search' => 'Поиск',
    'artist_index_name' => 'Имя',
    'artist_index_date' => 'Дата',
    'artist_index_updated_by' => 'Автор изменений',
    'artist_index_last_modified' => 'Обновлено',
    'artist_show_mass_edit' => 'массовая правка',
    'artist_show_url' => 'URL',
    'artist_show_edit' => 'Редактировать',
    'artist_show_delete' => 'Удалить',
    'artist_show_view_posts' => 'Просмотр творчества',
    'artist_show_create_alias' => 'Создать псевдоним',
    'artist_update_save' => 'Сохранить',
    'artist_update_cancel' => 'Отмена',
    'artist_update_preview' => 'Предпросмотр Примечания',
    'banned_reason' => 'Вас забанили:',
    'banned_expire' => 'Истекает ',
    'banned_period' => '.',
    'banned_permanent' => 'Навсегда',
    'batch_url' => 'URL',
    'batch_load_file_index' => 'Загрузить индексный файл',
    'batch_files' => 'Файлы',
    'batch_tags' => 'Метки',
    'batch_rating' => 'Рейтинг',
    'batch_rating_explicit' => 'Откровенный',
    'batch_rating_questionable' => 'Спорный',
    'batch_rating_safe' => 'Безопасный',
    'batch_start_upload' => 'Начать загрузку',
    'batch_username' => 'Пользователь',
    'batch_status' => 'Состояние',
    'batch_post' => 'Пост №',
    'batch_post_exists' => ' уже существует',
    'batch_uploading' => 'Загрузка',
    'batch_pending' => 'Ожидание',
    'batch_paused' => 'Пауза',
    'batch_complete' => ' - выполнено',
    'batch_queue_uploads' => 'Закачки в очередь',
    'batch_retry_failed' => 'Повтор неудачен',
    'batch_clear' => 'Очистить завершенные',
    'batch_cancel' => 'Отменить все закачки',
    'batch_pause' => 'Пауза',
    'batch_resume' => 'Продолжить',
    'comment_quote' => 'Цитата',
    'comment_edit' => 'Правка',
    'comment_delete' => 'Удалить',
    'comment_flag' => 'Пометить для удаления',
    'comment_reply' => 'Ответить »',
    'edit_comment' => 'Редактировать Комментарий',
    'comment_save' => 'Сохранить изменения',
    'comment_list' => 'Список',
    'comment_search' => 'Поиск',
    'comment_moderate' => 'Модерировать',
    'comment_help' => 'Справка',
    'comment_date' => 'Дата',
    'comment_user' => 'Пользователь',
    'comment_rating' => 'Рейтинг',
    'comment_score' => 'Оценка',
    'comment_hidden' => 'Скрытый',
    'comment_tags' => 'Метки',
    'comment_translation' => 'Комметарий переведён',
    'comment_author' => 'Автор',
    'comment_body' => 'Содержание',
    'comment_approve' => 'Одобрить',
    'comment_post' => 'Пост',
    'comment_message' => 'Сообщение',
    'comment_time' => 'Время',
    'comment_return' => 'Вернуться',
    'dmail_send' => 'Отправить',
    'dmail_preview' => 'Предварительный просмотр',
    'dmail_to' => 'Кому',
    'dmail_title' => 'Заголовок',
    'dmail_body' => 'Содержание',
    'dmail_compose' => 'Написать Сообщение',
    'dmail_footer_inbox' => 'Входящие',
    'dmail_footer_compose' => 'Написать',
    'dmail_mark' => 'Отметить все прочитанными',
    'dmail_inbox' => 'Мой Почтовый Ящик',
    'dmail_empty' => 'Нет сообщений',
    'dmail_from' => 'От кого',
    'dmail_when' => 'Когда',
    'dmail_ago' => ' назад',
    'dmail_mark_all_text' => 'Пометить прочитанными',
    'dmail_mark_all_text2' => 'Вы действительно хотите пометить все сообщения как прочитанные?',
    'dmail_yes' => 'Да',
    'dmail_no' => 'Нет',
    'dmail_message_sent' => 'Отправлено ',
    'dmail_message_ago' => ' назад',
    'forum_title' => 'Тема',
    'forum_post' => 'Отправить',
    'forum_preview' => 'Предпросмотр',
    'forum_search' => 'Поиск',
    'forum_last' => 'последняя',
    'forum_ago' => ' назад',
    'forum_created_by' => 'Создано',
    'forum_updated_by' => 'Изменено',
    'forum_updated' => 'Обновлено',
    'forum_responses' => 'Ответы',
    'forum_sticky' => 'Прикреплено: ',
    'forum_locked' => 'Эта темя закрыта.',
    'forum_mark' => 'Пометить всё прочитанным',
    'forum_help' => 'Справка',
    'forum_edit' => 'Правка',
    'forum_delete' => 'Удалить',
    'forum_delete_confirm' => 'Вы действительно хотите удалить это сообщение?',
    'forum_unstick' => 'Открепить',
    'forum_stick' => 'Прикрепить',
    'forum_unlock' => 'Открыть',
    'forum_lock' => 'Закрыть',
    'forum_quote' => 'Цитировать',
    'forum_new_text' => 'Новая тема',
    'forum_message' => 'Сообщение',
    'forum_author' => 'Автор',
    'forum_last_updated' => 'Последнее изменение',
    'forum_list' => 'Список',
    'forum_reply' => 'Ответить',
    'forum_new' => 'Новая тема',
    'forum_parent' => 'Родитель',
    'history_showall' => 'Показываются все метки',
    'history_showall2' => 'Показываются только изменения',
    'history_search' => 'Поиск',
    'history_undo' => 'Отменить',
    'history_redo' => 'Вернуть',
    'history_all' => 'Все',
    'history_posts' => 'Посты',
    'history_pools' => 'Коллекции',
    'history_tags' => 'Метки',
    ...
    'history_change' => 'Правка',
    'crop_avatar' => 'Выберите область для обрезки всех картинок и нажмие Enter. Эта операция не может быть отменена.',
    'inline_tag' => 'Встраиваемая метка: image #',
    'inline_preview' => 'Просмотр',
    'inline_add_image' => 'Добавить изображение',
    'inline_file' => 'Файл',
    'inline_source' => 'Источник',
    'inline_add' => 'Добавить',
    'inline_remove' => 'Удалить',
    'inline_remove_confirm' => 'Удалить это изображение?',
    'inline_move_up' => 'Выше',
    'inline_move_down' => 'Ниже',
    'inline_description' => 'Описание:',
    'inline_add_description' => 'щёлкните для добавления описания к этому набору',
    'inline_add_desc' => 'Добавить описание',
    'inline_save' => 'Сохранить изменения',
    'inline_delete' => 'Удалить',
    'inline_delete_confirm' => 'Удалить эту группу изображений?',
    'inline_crop' => 'Вырезать',
    'inline_copy' => 'Копировать',
    'inline_list' => 'Список',
    'inline_help' => 'Справк',
    'inline_first_image' => 'Первое изображение',
    'inline_description2' => 'Описание',
    'inline_user' => 'Пользователь',
    'inline_images' => 'Изображения',
    'inline_created' => 'Создано',
    'inline_ago' => ' назад',
    ...
    'layout_email_text' => 'Если вы указали адрес e-mail при регистрации, то Ваш пароль можно сбросить.',
    'layout_name' => 'Имя',
    'layout_email' => 'Email',
    'layout_password' => 'Пароль',
    'layout_confirm' => 'Подтвердите пароль',
    ...
    'layout_exists' => 'Данное имя уже занято. Если вы хотите создать новую учётную запись, выберите другое имя.',
    'layout_email_reset' => 'Введите адрес e-mail, указанный Вами в профиле. Вы получите письмо с новым паролем.',
    ...
    'layout_invalid_email' => 'Сбой доставки сообщения по указанному адресу e-mail.',
    'layout_logout' => 'Выйти',
    'layout_profile' => 'Мой Профиль',
    'layout_mail' => 'Моя Почта',
    'layout_fav' => 'Избранное',
    'layout_settings' => 'Настройки',
    'layout_change_pwd' => 'Сменить Пароль',
    'layout_account' => 'Моя Страница',
    ...
    'layout_img_search' => 'Поиск Изображений',
    'layout_history' => 'История',
    'layout_batch' => 'Групповая Загрузка',
    'layout_moderate' => 'Модерировать',
    'layout_posts' => 'Посты',
    'layout_view_comments' => 'Просмотр Комментариев',
    'layout_search_comments' => 'Поиск Комментариев',
    'layout_comments' => 'Комментарии',
    ...
    'public_text' => 'Публичные коллекции могут быть изменены другими пользователями.',
    ...
    'comment_ago' => ' назад',
    'comment_ago2' => '',
    'artist_title' => 'Это имя художника является псевдонимом',
    'artist_title2' => 'Этот художник является группой',
    'comment_translation_text' => 'Смотреть непереведённый текст',
    'comment_translation_text2' => 'Смотреть переведённый текст',
    'comments_post' => 'Отправить',
    'comments_more' => 'ещё',
    'comments_bump' => 'Отправить без поднятия',
    'comments_none' => 'Нет комментариев.',
    'dmail_preview_js_text' => 'Загрузка предпросмотра...',
    'dmail_ago2' => '',
    'dmail_message_ago2' => '',
    'forum_ago2' => '',
    'forum_ago3' => ' назад от ',
    ...
    'alias_search' => 'Поиск Синонимов',
    'imp_search' => 'Поиск Дополнительных Значений',
    'alias_alias' => 'Синоним',
    'alias_to' => 'Для',
    'alias_reason' => 'Обоснование',
    'alias_pending' => 'Выбрать неподтвержденные',
    'alias_approve' => 'Подтвердить',
    'alias_delete' => 'Удалить',
    'alias_add' => 'Добавить',
    'alias_reason2' => 'Обоснование:',
    'alias_text' => 'Добавить Синоним',
    'alias_text2' => 'Вы можете предложить новый синоним, но он должен быть подтверждён администратором.',
    'alias_name' => 'Имя',
    'alias_alias_to' => 'Синоним для',
    'alias_submit' => 'Отправить',
    'imp_pre' => 'Предикат',
    'imp_con' => 'Дополнение',
    'imp_text' => 'Добавить Дополнительное Значение',
    'imp_text2' => 'Вы можете предложить новое дополнительное значение для метки, но оно должно быть подтверждено модератором.',
    'imp_text3' => 'Предикат - метка, для которой добавляется метка дополнение. Например, дополнительное значение с предикатом=квадрат и дополнением=прямоугольник означает, что для каждого поста, помеченного как квадрат, будет также добавлена метка прямоугольник.',
    'sub_edit' => 'правка',
