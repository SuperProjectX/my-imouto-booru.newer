...
class Post_ImageStore_LocalHierarchy extends Post_ImageStore_Base
{
    ...
    {
        return RAILS_ROOT . "/public/data/image/" . $this->_file_hierarchy() . "/" . $this->_post->file_name();
    }
    ...
    {
        if ($this->_post->image())
            return RAILS_ROOT . "/public/data/preview/" . $this->_file_hierarchy() . "/" .$this->_post->md5.".jpg";
        else
    ...
    {
        return RAILS_ROOT . "/public/data/sample/" . $this->_file_hierarchy() . "/" . CONFIG()->sample_filename_prefix . $this->_post->md5 . ".jpg";
    }
