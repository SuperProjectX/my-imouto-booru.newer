...
trait PostImageStoreMethods
{
    ...
    {
        if (!$this->_store_class) {
            require_once dirname(__FILE__) . '/image_store/base.php';
            $this->_store_class = Post_ImageStore_Base::create_instance($this);
        }
        return $this->_store_class->$method();
    }
}