<?php
class WikiPageVersion extends ActiveRecord_Base
{
    ...
    {
        WikiPageVersion::find_first(['conditions' => ['wiki_page_id = ? AND version = ?', $this->wiki_page_id, $this->version - 1]]);
    }
    ...
    public function to_xml(array $options = array())
    {
        ...
        return to_xml(array('id' => $this->$this->id, 'created_at' => $this->$this->created_at, 'updated_at' => $this->updated_at, 'title' => $this->title, 'body' => $this->body, 'updater_id' => $this->user_id, 'locked' => $this->is_locked, 'version' => $this->version, 'post_id' => $this->post_id), $options);
    }
