...
<?php else: ?>
  ...
  <?= $this->form_tag('user#create', function(){ ?>
    <table class="form">
      <tfoot>
        <tr>
          <td colspan="2">
      ...
      <tbody>
        <tr>
          ...
          <td width="85%">
            <?=$this->text_field("user", "name", ['size' => '30']) ?>
          </td>
        </tr>
        <tr>
          <th>
            <label class="block" for="user_email"><?= $this->t('user_signup_email') ?></label>
            <p><?= $this->t('user_singup_email_text') ?></p>
          </th>
          <td>
            <?=$this->text_field("user", "email", ['size' => '30']) ?>
          </td>
        </tr>
        <tr>
          <th>
          ...
          <td>
            <?=$this->password_field("user", "password", ['size' => '30']) ?>
          </td>
        </tr>
        <tr>
          <th>
          ...
          <td>
            <?=$this->password_field("user", "password_confirmation", ['size' => '30']) ?>
          </td>
        </tr>
      </tbody>
    </table>
